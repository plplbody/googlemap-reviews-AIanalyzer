...
flowchart LR
    ...
    subgraph ACT_3_3 ["ACT-3-3: コンテキスト学習"]
        ...
        D_02[("<b>D-02: Users</b><br/>users/{uid}<br/>(Base Vector)")]:::db
        D_06[("<b>D-06: users/{uid}/scenarios/{id}</b><br/><b>[フィールド]</b><br/>- シーン別ベクトル")]:::db

        U_09 -- "シーン選択（複数選択可）" --> L_10
        L_10 -. "サーバー処理: メインベクトル更新" .-> D_02
        L_10 -. "サーバー処理: 選択されたシーンのサブコレクション更新" .-> D_06
    end

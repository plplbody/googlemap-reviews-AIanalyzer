...
flowchart LR
    ...
    %% Start/End
    S3_Start(("<b>Start</b><br/>評価")):::startend
    S3_End(("<b>End</b><br/>個別最適化")):::startend

    subgraph ACT_3_1 ["ACT-3-1/3-2: 評価とシーン選択"]
        direction TB
        U_02["<b>U-02: List View</b><br/><b>U-03: Detail View</b>"]:::ui
        U_09["<b>U-09: Scene Picker</b><br/><b>[デフォルトシーンセクション]</b><br/>- シーン選択ボタン（デート, 一人等）<br/><b>[カスタムシーンセクション]</b><br/>- シーン選択ボタン<br/>- カスタムシーン作成ボタン"]:::ui
        
        U_02 -- "アクション: いいねボタンを押下" --> U_09
    end

    subgraph ACT_3_3 ["ACT-3-3: コンテキスト学習"]
        direction TB
        L_10["<b>L-10: Learning Logic</b><br/>- ユーザーのメインベクトル更新<br/>- 選択されたシーンのサブコレクションを更新/作成"]:::logic
        
        D_02[("<b>D-02: Users</b><br/>users/{uid}<br/>- 平均ベクトル<br/>- 平均評価軸傾向")]:::db
        D_06[("<b>D-06: users/{uid}/scenarios/{id}</b><br/><b>[フィールド]</b><br/>- シーン別ベクトル<br/>- シーン別評価軸傾向")]:::db

        U_09 -- "シーン選択（複数選択可）" --> L_10
        L_10 -. "サーバー処理: 更新（常時）" .-> D_02
        L_10 -. "サーバー処理: 更新（選択されたシーンのみ）" .-> D_06
    end

    subgraph ACT_3_4 ["ACT-3-4: 再ランキング"]
        direction TB
        U_List["<b>U-02: List View</b><br/>- シーンフィルタ選択"]:::ui
        L_Rank["<b>L-03: Re-ranking</b><br/>- 選択中のシーンベクトルを使用"]:::logic

        U_List -- "アクション: 利用シーン選択" --> L_Rank
        D_06 -. "サーバー処理: ベクトル読込" .-> L_Rank
        D_02 -. "サーバー処理: ベクトル読込" .-> L_Rank
        L_Rank --"サーバ処理: マッチ度計算"--> U_List
    end

    S3_Start -- "閲覧/Good" --> ACT_3_1
    ACT_3_1 --> ACT_3_3
    ACT_3_3 --> ACT_3_4
    ACT_3_4 --> S3_End
```

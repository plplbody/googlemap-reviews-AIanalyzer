...
export function SelectionButton({
    ...
    const chipStyles = isSelected
        ...
        : "bg-white text-brand-black border border-brand-gray hover:border-brand-orange-dark hover:text-brand-orange-dark px-4 py-2 shadow-sm";

    const segmentStyles = isSelected
        ? "bg-brand-orange-dark text-white shadow-sm px-4 py-1.5"
        : "text-brand-black hover:bg-brand-gray-light hover:text-brand-orange-dark px-4 py-1.5";

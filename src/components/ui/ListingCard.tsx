            ...
            <div className="flex flex-col gap-1">
                ...
                {tags && tags.length > 0 && (
                    <div className="flex gap-2 mb-1">
                        {tags.map((tag, i) => (
                            <span key={i} className="text-[10px] uppercase tracking-wider font-medium text-brand-orange-dark border border-brand-orange-dark/20 px-2 py-0.5 rounded-full">
                                {tag}
                            </span>
                        ))}
                    </div>
                ...
                <div className="flex justify-between items-baseline">
                    <h3 className="text-lg font-serif font-bold text-gray-900 group-hover:text-brand-orange-dark transition-colors duration-300 line-clamp-1">
                        {title}
                    </h3>

    ...
    if (place.status === 'pending' || place.status === 'processing' || isRetrying) {
        ...
        return (
            <div className="flex flex-col items-center justify-center p-12 space-y-4 animate-pulse">
                ...
                <p className="text-type-subtitle text-brand-black-dark">AIが分析中...</p>
        ...
        <div className="w-full max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-brand-gray p-6 md:p-8">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2 text-type-memo text-brand-black mt-1">
                        {place.address && (
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {yourScore ? (
                            <div className="bg-white p-6 rounded-xl shadow-lg border border-brand-orange-dark flex flex-col items-center justify-center relative overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                                ...
                                <h3 className="text-type-subtitle text-brand-orange-dark mb-2">あなたとのマッチ度</h3>
                                ...
                                <div className="mt-4 flex flex-col items-center gap-1">
                                    <p className="text-type-body font-bold text-brand-black-light">AI分析スコア</p>
                                    <span className="text-type-subtitle text-brand-black">{place.trueScore?.toFixed(1)}</span>
                                </div>
                            </div>
                        ) : (
                            <div className="bg-white p-6 rounded-xl shadow-sm border border-brand-orange-dark flex flex-col items-center justify-center relative overflow-hidden">
                                ...
                                <h3 className="text-type-subtitle mb-2 text-brand-orange-dark">AI分析スコア</h3>
                                <div className="flex items-baseline">
                                    <span className="text-type-title text-brand-orange-dark tabular-nums">{place.trueScore?.toFixed(1)}</span>
                                    <span className="text-type-subtitle text-brand-orange-dark ml-1">/5.0</span>
                                </div>
                                <div className="flex items-center mt-2 text-brand-orange-dark">
                                    {[...Array(5)].map((_, i) => (
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 flex flex-col items-center justify-center">
                            <h3 className="text-type-subtitle text-gray-500 mb-2">Google Map</h3>
                            <div className="flex items-baseline">
                                <span className="text-type-title text-gray-700 tabular-nums">{place.originalRating.toFixed(1)}</span>
                                <span className="text-type-subtitle text-gray-400 ml-1">/5.0</span>
                            </div>
                            ...
                            <p className="text-type-memo text-gray-500 mt-2">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
                        ...
                        <div className="col-span-1 lg:col-span-1 bg-white rounded-2xl md:rounded-3xl shadow-lg border border-brand-gray p-3 md:p-8 h-auto aspect-square md:aspect-auto md:h-96 flex flex-col justify-center">
                            <h3 className="text-type-body font-semibold text-brand-black-dark mb-2 md:mb-6 text-center md:text-left">バランス分析</h3>
...
function InfoGroup({ title, icon: Icon, children }: any) {
    return (
        <div className="space-y-4">
            <div className="flex items-center gap-2 text-brand-black-dark border-b border-brand-gray pb-2">
    ...
    return (
        <div className={`group p-6 rounded-2xl border-2 transition-all duration-300 hover:shadow-lg ${isHigh ? 'bg-white border-rose-100 hover:border-rose-200' : 'bg-brand-gray-light border-transparent'}`}>
            <div className="flex justify-between items-start mb-4">
                <div>
                    <div className="text-brand-black-dark text-type-body font-semibold">{label}</div>
        ...
        <div className="bg-white p-3 md:p-6 rounded-2xl border border-brand-gray shadow-sm hover:shadow-md transition-shadow flex items-center md:items-start gap-3 md:gap-4 h-full">
            ...
            <div className="flex-1 min-w-0">
                <div className="flex justify-between items-baseline mb-1">
                    <h4 className="text-type-body font-semibold text-brand-black-dark truncate mr-1">{label}</h4>
                    <span className="text-type-subtitle text-brand-black-dark tabular-nums">{value?.toFixed(1)}</span>
                </div>

        ...
        <main className="min-h-screen bg-[#FAFAFA] text-[#1A1A1A] font-serif">
            ...
            <div className="pt-32 pb-24 container mx-auto px-6 max-w-5xl">
                ...
                <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 mb-8 flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div className="w-full md:w-64 md:ml-auto border-t md:border-t-0 md:border-l border-slate-100 pt-6 md:pt-0 md:pl-6">
                        <p className="text-xs font-bold text-slate-400 mb-2 text-center md:text-left">あなたの好み傾向</p>

...
import { getRankingPlaces } from '@/server/actions/ranking';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
    ...
    const title = `${cityName}の${sceneName}向きレストランTOP10【AI分析】 | AI Concierge`;
            ...
            <div className="container mx-auto px-4 py-8 pt-24 max-w-5xl">
                ...
                <header className="mb-10 text-center">
                    <h1 className="text-3xl md:text-4xl font-extrabold text-brand-black mb-4 leading-tight">
                        ...
                        {cityName}の<span className="text-brand-orange-dark">{sceneName}</span>TOP10
                    </h1>
                ...
                {isLowQuality ? (
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 text-center my-12">
                        ...
                        {/* Logic to link to nearby areas could go here, for now generic CTA */}
                    </div>
                ) : (
                    /* Ranking List */
